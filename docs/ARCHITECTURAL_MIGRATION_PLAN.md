...
- [ ] Skapa mappstruktur på `C:\Gemini-Core`.
- [ ] Kopiera källkod och projekt-mappar från `H:` till `C:`.
- [ ] Sätta upp Virtuell Miljö (`.venv`) och installera beroenden.
- [ ] Verifiera att skripten kan köras lokalt.

### FAS 2: Git-Integration (Säkerhet)
- [ ] Initiera Git-repo i `C:\Gemini-Core`.
- [ ] Skapa en strikt `.gitignore` (Skydda nycklar!).
...
- [ ] Starta den nya `main.py` som central operatörs-hubb.
